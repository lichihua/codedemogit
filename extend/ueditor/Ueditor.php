...
class Ueditor{
	...
	public function __construct($uid = ''){
		...
		\ueditor\FileStorage::connect("File");
		//导入设置
		$CONFIG = json_decode(preg_replace("/\/\*[\s\S]+?\*\//", "", file_get_contents(ROOT_PATH."extend/ueditor/ueditor.json")), true);
		var_dump(ROOT_PATH."extend/ueditor/ueditor.json");
